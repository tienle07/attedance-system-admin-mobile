...
class LeaveListRequest extends StatefulWidget {
  const LeaveListRequest({Key? key}) : super(key: key);

  @override
  _LeaveListRequestState createState() => _LeaveListRequestState();
}

class _LeaveListRequestState extends State<LeaveListRequest> {
  @override
  void initState() {
    super.initState();
                        ...
                        children: [
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '12 July, 2023', // Thay đổi giá trị tương ứng
                                    style: kTextStyle,
                                  ),
                                ],
                              ),
                          ...
                          const Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Approved', // Thay đổi giá trị tương ứng
                                style: TextStyle(
                                  color: Colors
                                      .green, // Màu xanh cho trạng thái Approved
                                  fontSize: 16.0,
                                ),
                              ),
                            ],
