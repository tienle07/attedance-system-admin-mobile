...
class EditProfileHrScreen extends StatefulWidget {
  ...
  @override
  State<EditProfileHrScreen> createState() => _EditProfileHrScreenState();
}

class _EditProfileHrScreenState extends State<EditProfileHrScreen> {
  ...
  EmployeeProfileModel employeeProfile = EmployeeProfileModel();
  ...
  void initState() {
    ...
    employeeProfile = widget.employeeProfile ?? EmployeeProfileModel();
    super.initState();
