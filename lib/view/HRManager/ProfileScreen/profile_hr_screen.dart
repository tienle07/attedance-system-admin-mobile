...
class ProfileHrScreen extends StatefulWidget {
  const ProfileHrScreen({Key? key}) : super(key: key);
...
class _ProfileScreenState extends State<ProfileHrScreen> {
            ...
            children: [
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        contentPadding: EdgeInsets.fromLTRB(20, 16, 10, 15),
                        labelText: 'Gender',
                        hintText: employeeProfile?.employeeResponse?.sex ?? '',
                        labelStyle: kTextStyle,
                        hintStyle: kTextStyle.copyWith(fontSize: 15),
                        floatingLabelBehavior: FloatingLabelBehavior.always,
                        border: OutlineInputBorder(
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  contentPadding: EdgeInsets.fromLTRB(20, 16, 10, 15),
                  labelText: 'Issued By',
                  hintText: employeeProfile?.employeeResponse?.issuedBy ?? '',
                  labelStyle: kTextStyle,
                  hintStyle: kTextStyle.copyWith(fontSize: 15),
                  floatingLabelBehavior: FloatingLabelBehavior.always,
                  border: OutlineInputBorder(
