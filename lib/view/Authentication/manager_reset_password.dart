...
class ResetPasswordManagerScreen extends StatefulWidget {
  const ResetPasswordManagerScreen({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _ResetPasswordManagerScreenState createState() =>
      _ResetPasswordManagerScreenState();
}

class _ResetPasswordManagerScreenState
    extends State<ResetPasswordManagerScreen> {
  @override
  void initState() {
    super.initState();
