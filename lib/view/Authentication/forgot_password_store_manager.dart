...
class ForgotPasswordStoreManager extends StatefulWidget {
  const ForgotPasswordStoreManager({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _ForgotPasswordStoreManagerState createState() =>
      _ForgotPasswordStoreManagerState();
}

class _ForgotPasswordStoreManagerState
    extends State<ForgotPasswordStoreManager> {
  ...
  Future<void> forgotPasswordManager() async {
